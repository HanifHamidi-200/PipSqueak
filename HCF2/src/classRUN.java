...
public class classRUN {
	...
	private double _NeededMass1;
	private double _NeededMass2;
	private double _NeededFactor1;
	private double _NeededFactor2;
	private int mnMode;
	private double _BOX1Answer, _BOX3Answer, _BOX4Answer, _BOX5Answer;
	...
	public void fDisplay() {
		String sText;
		int nA = _HCF/_metalvalence;
		int nB = _HCF/_gasvalence;
		
		System.out.println("======================");
		System.out.println("RUN");
		System.out.println("======================");
		System.out.println("METAL");
		sText = "[1] ElementName = " + ElementName1[_metal-1];
		System.out.println(sText);
		sText = "[2] ElementSymbol = " + ElementSymbol1[_metal-1];
		System.out.println(sText);
		sText = "[3] ElementValence = " + ElementValence1[_metal-1];
		System.out.println(sText);
		sText = "[4] AtomicNumber = " + AtomicNumber1[_metal-1];
		System.out.println(sText);
		sText = "[5] MassNumber = " + MassNumber1[_metal-1];
		System.out.println(sText);
		System.out.println("======================");
		System.out.println("GAS");
		sText = "[1] ElementName = " + ElementName2[_gas-1];
		System.out.println(sText);
		sText = "[2] ElementSymbol = " + ElementSymbol2[_gas-1];
		System.out.println(sText);
		sText = "[3] ElementValence = " + ElementValence2[_gas-1];
		System.out.println(sText);
		sText = "[4] AtomicNumber = " + AtomicNumber2[_gas-1];
		System.out.println(sText);
		sText = "[5] MassNumber = " + MassNumber2[_gas-1];
		System.out.println(sText);
		System.out.println("======================");
		sText = "ORIGINALMASS = " + _originalmass;
		System.out.println(sText);
			sText = "FORMULA = " + ElementSymbol1[_metal-1];
		if(nA>1) {
			sText = sText + nA;
		}
		sText = sText + ElementSymbol2[_gas-1];
		if(nB>1) {
			sText = sText + nB;
		}
		System.out.println(sText);
	...
	private void fBox1() {
		...
		System.out.printf("dAnswer = %s\n",dAnswer);
		_BOX1Answer = dAnswer;
	}
	private void fBox2() {
		double d1, d2, dAnswer;
		
		if(mnMode==1 && _NeededFactor1==1) {
			
		}
		else if(mnMode==2 && _NeededFactor2==1) {
	...
	public void fProcess() {
		_NeededMass1 = MassNumber1[_metal-1];
		_NeededMass2 = MassNumber2[_gas-1];
		_NeededFactor1 = _HCF/_metalvalence;
		_NeededFactor2 = _HCF/_gasvalence;
